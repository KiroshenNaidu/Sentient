    ...
    <Card>
      ...
      <CardContent className="space-y-4">
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          />
          <Button type="submit" className="w-full text-primary-foreground disabled:text-primary-foreground/70 bg-gradient-to-r from-primary via-accent to-secondary bg-[length:200%_auto] enabled:hover:animate-color-wave enabled:hover:text-primary-foreground" disabled={isLoading || !text.trim()}>
